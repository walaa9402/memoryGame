			...
			{ 	
				...
				setTimeout(function(){
					...
					if(win==6)
					{
						...
						document.getElementsByClassName('row1')[0].innerHTML="<h1><br>congratulation!<br><br>YOU Successfully Pass Level 1<br><h1>by ( "+(59-t)+" ) seconds!</h1><h1>Go To <a href='level2.html' style='text-decoration:none;'>Level 2</a>?</h1><br><br><br><br></h1>";
						show=[];
					}	
					},300);
				}
	...
	var time=setInterval(function(){
		document.getElementById("time").innerHTML = "Time : "+t--;
	 	if(t<0){
	  		...
	  		{
	  			document.getElementsByClassName('row2')[0].classList.add("hide");
		    	document.getElementsByClassName('row1')[0].innerHTML="<h1><br><br><br><br>GAME OVER<br><br><br><br><br><br></h1>";
		    }
		}
	},1000);
