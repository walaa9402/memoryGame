			...
			{ 
				...
				setTimeout(function(){
					...
					if(win==12)
					{
						...
						document.getElementsByClassName('row1')[0].innerHTML="<h1><br><br><br>YOU Successfully Pass Level 2<h1>by ( "+(89-t)+" ) seconds!</h1><h1> <a href='index.html' style='text-decoration:none;'>Play Again</a>?</h1><br><br><br></h1>";
					}	
					},300);
				}
			}
